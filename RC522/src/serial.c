 ...
 * Attribution:
 *
 *   Some parts of the code were written by goliath. They may have been used
 *   very differently, though it is still his code and it was used here with his
 *   consent.
 */
